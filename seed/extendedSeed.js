...
export const seedExtendedData = async () => {
  ...
  try {
    ...
    const announcements = [
      { id: 'ann-1', title: 'Mid-Term Examination Schedule Released', body: 'The mid-term examination schedule has been published. Please check the exam portal for detailed timings and seating arrangements. All students must carry their school ID cards.', category: 'exam', scope: 'school', class_id: null, created_by: 'admin-1', pinned: true, priority: 'high', created_at: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      { id: 'ann-2', title: 'Annual Sports Day - Registrations Open', body: 'Annual Sports Day will be held on May 25th. Students can register for various events including athletics, team sports, and creative activities. Last date for registration is May 18th.', category: 'event', scope: 'school', class_id: null, created_by: 'admin-1', pinned: true, priority: 'medium', created_at: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      ...
      { id: 'ann-4', title: 'Fee Payment Reminder - Final Due Date', body: 'This is a reminder that the second term fee payment is due by May 15th. Parents who have not yet paid can use the online payment portal or visit the school office.', category: 'administrative', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'high', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
      ...
      { id: 'ann-7', title: 'School Holiday - Independence Day', body: 'School will remain closed on August 15th on account of Independence Day. Regular classes resume from August 16th.', category: 'holiday', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'medium', created_at: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      ...
      { id: 'ann-10', title: 'Computer Science Workshop Registration', body: 'A 3-day workshop on Python programming starts next week. Limited seats available. Register through the club portal.', category: 'event', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'medium', created_at: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      ...
      { id: 'ann-13', title: 'Annual Day Rehearsal Schedule', body: 'Annual day rehearsals begin from May 16th. Check the notice board for your stage slot and costume requirements.', category: 'schedule', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'medium', created_at: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      ...
      { id: 'ann-15', title: 'Library Hours Extended During Exams', body: 'The library will remain open until 8 PM on all weekdays during the examination period for student reference.', category: 'administrative', scope: 'school', class_id: null, created_by: 'librarian-1', pinned: false, priority: 'low', created_at: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      ...
      { id: 'ann-17', title: 'Class 10 Toppers Felicitation Ceremony', body: 'Top performers from the previous term will be felicitated on May 30th. Parents are invited to attend the ceremony at 10 AM in the main auditorium.', category: 'achievement', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'medium', created_at: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      { id: 'ann-18', title: 'Bus Route Timings Updated', body: 'New bus timings have been uploaded to the parent portal. Please review and inform the transport office of any conflicts.', category: 'administrative', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'high', created_at: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      ...
      { id: 'ann-20', title: 'PTM Date Announced - May 28th', body: 'Parent-Teacher Meeting for Term 2 will be held on May 28th from 9 AM to 2 PM. Parents must carry the progress report card.', category: 'administrative', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'high', created_at: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      { id: 'ann-21', title: 'Yoga and Meditation Workshop', body: 'A wellness workshop on yoga and meditation will be conducted on May 24th for all students. Sign up through the student portal.', category: 'event', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'low', created_at: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      ...
      { id: 'ann-24', title: 'School Magazine Submission Open', body: 'Submit your poems, short stories, and articles for the school magazine by May 31st. Email to magazine@schoolsync.edu.', category: 'event', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'low', created_at: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      { id: 'ann-25', title: 'Health Camp - Eye and Dental Checkup', body: 'Free health checkup camp on May 26th in the school auditorium. All students are encouraged to participate.', category: 'health', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'medium', created_at: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      ...
      { id: 'ann-27', title: 'Computer Lab Upgradation Complete', body: 'The computer lab has been upgraded with new systems and software. Lab access resumes from May 16th.', category: 'administrative', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'low', created_at: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      { id: 'ann-28', title: 'English Grammar Workshop', body: 'An interactive grammar workshop for Classes 9 and 10 on May 23rd. Register at the reception.', category: 'event', scope: 'school', class_id: null, created_by: 'teacher-3', pinned: false, priority: 'low', created_at: new Date(Date.now() - 6 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      { id: 'ann-29', title: 'Scholarship Applications Open', body: 'Applications for the merit scholarship are now open. Submit forms with required documents by May 25th.', category: 'administrative', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'high', created_at: new Date(Date.now() - 9 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      { id: 'ann-30', title: 'Mandatory Assembly - Monday', body: 'All students must attend the Monday assembly without fail. Formations begin at 8:00 AM sharp.', category: 'schedule', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'medium', created_at: new Date(Date.now() - 12 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      { id: 'ann-31', title: 'Physics Olympiad Registration', body: 'National Physics Olympiad registrations are open. Interested students should contact the physics department by May 20th.', category: 'event', scope: 'school', class_id: null, created_by: 'teacher-2', pinned: false, priority: 'medium', created_at: new Date(Date.now() - 8 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      ...
      { id: 'ann-33', title: 'Diwali Holiday Announcement', body: 'School will remain closed from November 1st to 7th for Diwali festivities. Classes resume on November 8th.', category: 'holiday', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'high', created_at: new Date(Date.now() - 15 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      ...
      { id: 'ann-35', title: 'Fire Drill Scheduled', body: 'A mandatory fire safety drill will be conducted on May 24th at 10 AM. Follow all safety instructions.', category: 'urgent', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'high', created_at: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      ...
      { id: 'ann-37', title: 'Student Council Elections', body: 'Student council elections for the academic year will be held on May 27th. Nomination forms available at admin office.', category: 'administrative', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'medium', created_at: new Date(Date.now() - 6 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      { id: 'ann-38', title: 'Science Exhibition Entries Invited', body: 'Annual science exhibition on June 5th. Submit your project proposals by May 22nd. Categories: physics, chemistry, biology, environmental science.', category: 'event', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'medium', created_at: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      { id: 'ann-39', title: 'English Speaking Competition', body: 'Inter-class English elocution competition on May 29th. Topic: "Technology in Education". Register by May 23rd.', category: 'event', scope: 'school', class_id: null, created_by: 'teacher-3', pinned: false, priority: 'medium', created_at: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      { id: 'ann-40', title: 'Attendance Shortfall Warning', body: 'Students with attendance below 75% have been flagged. Parents will be contacted. Ensure regular school attendance.', category: 'urgent', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'high', created_at: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      ...
      { id: 'ann-43', title: 'School Uniform Guidelines Updated', body: 'New uniform guidelines have been issued. Full details available on the parent portal. Implementation from June 1st.', category: 'administrative', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'low', created_at: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      { id: 'ann-44', title: 'Art and Craft Exhibition', body: 'Showcase your paintings, sketches, and craft work in the annual exhibition. Submit entries by May 24th.', category: 'event', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'low', created_at: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      { id: 'ann-45', title: 'Mathematics Model Paper Released', body: 'Sample model question papers for the annual exam are now available in the student portal.', category: 'exam', scope: 'school', class_id: null, created_by: 'teacher-1', pinned: false, priority: 'high', created_at: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      ...
      { id: 'ann-47', title: 'Water Conservation Drive', body: 'School is launching a water conservation campaign. Form groups and submit proposals by May 26th.', category: 'event', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'low', created_at: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      { id: 'ann-48', title: 'Class Photo Day - May 29th', body: 'Individual and class photographs will be taken on May 29th. Wear clean uniform and be present on time.', category: 'schedule', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'medium', created_at: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
      ...
      { id: 'ann-50', title: 'Semester Fee Payment Window Closing', body: 'Last date to pay semester fees without penalty is May 15th. Pay online or at the accounts office before 4 PM.', category: 'administrative', scope: 'school', class_id: null, created_by: 'admin-1', pinned: false, priority: 'high', created_at: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString(), updated_at: new Date().toISOString() },
    ];
