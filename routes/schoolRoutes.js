...
import {
  ...
  createAssignmentWithSuppliesSchema,
  createClassSchema,
  createMarkSchema,
  createStudentProfileSchema,
  createTeacherProfileSchema,
  createUniformScheduleSchema,
  gradeSubmissionSchema,
  markAttendanceSchema,
  saveTimetableSchema,
  sendMessageSchema,
  stationeryAlertSchema,
  bookHeavyDaySchema,
  updateAssignmentSuppliesSchema,
...
router.patch('/assignments/:assignmentId/supplies', allowRoles('teacher', 'admin'), validateRequest(updateAssignmentSuppliesSchema), updateAssignmentSupplies);
